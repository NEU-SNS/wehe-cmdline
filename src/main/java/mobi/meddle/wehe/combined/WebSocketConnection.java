...
/**
 * Client to connect to a server using a WebSocket (ws:// or wss://). Two connections are made when
 * using MLab servers: one is the Side Channel, which uses the regular HTTPS connection; the other
 * is through this WebSocket to authenticate this client. The connection to the server through the
...
public class WebSocketConnection {
   ...
   *
   * @param id        the id number of the socket (used for debugging statements)
   ...
   *                             different server (implemented in Replay)
   */
