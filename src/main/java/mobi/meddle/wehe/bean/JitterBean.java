...
/**
 * Tracks payloads sent to and received from the server for each UDP replay. Currently, doesn't seem
 * super useful, as the ArrayLists are only being added to, not used.
 */
