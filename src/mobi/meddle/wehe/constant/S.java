...
public final class S {
  ...
  public static final String USAGE = "Usage: java -jar wehe-cmdline.jar -n [TEST_NAME] [OPTION]...\n\n"
          ...
          + "  -s SERV_NAME host name or IP of server to run the tests (Default: wehe4.meddle.mobi)\n"
          + "  -c           turn off confirmation replays (if test is inconclusive, will automatically\n"
          + "                 rerun by default\n"
